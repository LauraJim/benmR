...
```{r example, echo=F, out.width="60%", out.height="60%", fig.cap="Figure 1: Example of the output from the function plotdata"}
knitr::include_graphics("plotdata_example.png")
```

## *priorpar*: Setting the values of the *a priori* parameters

The *a priori* density functions of the parameters of interest, $\mu$ and $A$
...
<!--- Chunk for showing the use of the function priorpar. Dependencies: backAM, Spocc --->
